...
function RewindMessageAction({ matched, sessionId, openRestoredSession }) {
    ...
    const [mode, setMode] = (0, react_1.useState)('conversation');
    ...
    const applyConversation = async () => {
        if (!conversationReady || applyPending.current)
            return;
        ...
        try {
            ...
            const result = recordOf(await responseJson(response));
            if (requiredString(result.action, 'action') !== 'rewindConversation')
    ...
    const applyRestore = async () => {
        if (ready === null || !fileApplyReady || applyPending.current)
            return;
        const body = {
            mode,
            sessionId,
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-tail", children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Tooltip, { label: t('rewind.tooltip'), side: "bottom", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: "dcl-rewind-trigger", onClick: show, "aria-label": t('rewind.aria'), children: (0, jsx_runtime_1.jsx)(RewindIcon, { size: 16 }) }) }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Modal, { open: open, onClose: close, title: t('rewind.title'), closeLabel: t('rewind.close'), description: t('rewind.description'), className: "dcl-rewind-dialog", contentClassName: "dcl-rewind-content", footer: ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", onClick: close, disabled: applying, children: t('rewind.cancel') }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "primary", onClick: () => { void apply(); }, disabled: !canApply, children: applying ? t('rewind.applying') : completed === null ? actionLabel : t('rewind.done') })] })), children: (0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-body", children: [(0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-target", children: t('rewind.targetMessage', { prompt: matched.promptText }) }), loading && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-status", children: t('rewind.loading') }), preview?.status === 'pending' && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-status", children: t('rewind.pending') }), preview?.status === 'missing' && !nonGit && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: t('rewind.missing') }), nonGit && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-warning", children: t('rewind.nonGitRepo') }), preview?.status === 'failed' && (0, jsx_runtime_1.jsxs)("p", { className: "dcl-rewind-error", children: [t('rewind.failed'), preview.error] }), (0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-options", children: [(0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-option", "data-selected": mode === 'conversation', "data-disabled": applying, children: [(0, jsx_runtime_1.jsx)("input", { type: "radio", name: radioName, checked: mode === 'conversation', disabled: applying, onChange: () => { chooseMode('conversation'); } }), (0, jsx_runtime_1.jsxs)("span", { className: "dcl-rewind-option-content", children: [(0, jsx_runtime_1.jsx)("strong", { children: t('rewind.optionConversationTitle') }), (0, jsx_runtime_1.jsx)("span", { className: "dcl-rewind-option-description", children: t('rewind.optionConversationDesc') })] })] }), showFileOptions && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-option", "data-selected": mode === 'both', "data-disabled": applying, children: [(0, jsx_runtime_1.jsx)("input", { type: "radio", name: radioName, checked: mode === 'both', disabled: applying, onChange: () => { chooseMode('both'); } }), (0, jsx_runtime_1.jsxs)("span", { className: "dcl-rewind-option-content", children: [(0, jsx_runtime_1.jsx)("strong", { children: t('rewind.optionBothTitle') }), (0, jsx_runtime_1.jsx)("span", { className: "dcl-rewind-option-description", children: t('rewind.optionBothDesc') })] })] }), (0, jsx_runtime_1.jsxs)("label", { className: "dcl-rewind-option", "data-selected": mode === 'code', "data-disabled": applying, children: [(0, jsx_runtime_1.jsx)("input", { type: "radio", name: radioName, checked: mode === 'code', disabled: applying, onChange: () => { chooseMode('code'); } }), (0, jsx_runtime_1.jsxs)("span", { className: "dcl-rewind-option-content", children: [(0, jsx_runtime_1.jsx)("strong", { children: t('rewind.optionCodeTitle') }), (0, jsx_runtime_1.jsx)("span", { className: "dcl-rewind-option-description", children: t('rewind.optionCodeDesc') })] })] })] }))] }), (0, jsx_runtime_1.jsx)("div", { className: "dcl-rewind-summary", children: mode === 'conversation'
                                ? (0, jsx_runtime_1.jsx)("strong", { children: t('rewind.summaryConversation') })
                                : ready !== null
                                    ? (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("strong", { children: t('rewind.summaryFiles', { count: ready.totalChanges }) }), (0, jsx_runtime_1.jsx)("span", { children: mode === 'both' ? t('rewind.summaryBoth') : t('rewind.summaryCode') })] })
                                    : null }), sharedBlocked && ((0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: t('rewind.blockedShared') })), ready !== null && ready.headChanged && !ready.operationChanged && ((0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-warning", children: branchChanged
                                ? t('rewind.warnBranchChanged')
                                : t('rewind.warnHeadChanged') })), driftBlocked && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-warning", children: t('rewind.warnDrift') }), planMissing && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: t('rewind.planMissing') }), stale && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: t('rewind.stale') }), ready !== null && ready.totalChanges === 0 && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-status", children: t('rewind.noChanges') }), ready !== null && ready.changes.length > 0 && ((0, jsx_runtime_1.jsx)("div", { className: "dcl-rewind-files", children: ready.changes.map(change => (0, jsx_runtime_1.jsxs)("div", { className: "dcl-rewind-file", children: [(0, jsx_runtime_1.jsx)("code", { children: change.path }), (0, jsx_runtime_1.jsx)("span", { className: "dcl-rewind-kind", children: fileRecoveryLabel(change.kind, lang) })] }, change.path)) })), ready !== null && ready.truncated && ((0, jsx_runtime_1.jsx)("div", { className: "dcl-rewind-file-actions", children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", size: "sm", onClick: () => { void loadAllChanges(); }, disabled: loadingDetails, children: loadingDetails ? t('rewind.loadingDetails') : t('rewind.viewAll', { count: ready.totalChanges }) }) })), completed !== null && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-status", children: completed }), error !== null && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-error", children: error }), error !== null && mode !== 'conversation' && (0, jsx_runtime_1.jsx)("p", { className: "dcl-rewind-backup", children: t('rewind.backupNote') }), !loading && (preview?.status !== 'ready' || stale || planMissing || sharedBlocked || driftBlocked) && (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { className: "dcl-rewind-retry", variant: "outline", size: "sm", onClick: () => { void load(); }, children: t('rewind.retry') })] }) })] }));
}
